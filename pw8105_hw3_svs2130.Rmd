...
* Following are the vatiables in the dataset: **`r colnames(accel)`**.
...
We plotted a graph of the amoung of activity for each day of the week over 24 hours of time. We can observe that the peak activity is on fridays between 19th and 21st hour. The activity is least during the 0th to 4th hour in the morning and gradually increases.
